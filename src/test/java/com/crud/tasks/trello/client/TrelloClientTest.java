...
class TrelloClientTest {
    ...
    void shouldReturnEmptyList() throws URISyntaxException {
        ...
        final var uri = new URI("http://test.com/members/test/boards?key=test&token=test&fields=name,id&lists=all");

        when(restTemplate.getForObject(uri, TrelloBoardDto[].class)).thenReturn(null);

        // When
        final var fetchedTrelloBoards = trelloClient.getTrelloBoards();
